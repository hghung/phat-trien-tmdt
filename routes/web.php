...
Route::group(['prefix'=>'tai-khoan'],function(){
	...
	//ajax
 	Route::get('/quan-huyen/{id_province}','TaikhoanController@ajax_district');
 	Route::get('/phuong-xa/{id_ward}','TaikhoanController@ajax_ward');
...
Route::get('/xu-ly-{id}','BillController@status5')->name('status5');
Route::get('/van-chuyen-{id}','BillController@status6')->name('status6');
...
Route::get('/the-loai-{id}','PageController@book_subcategory')->name('p.subcategory'); // show layout không xài group dc
